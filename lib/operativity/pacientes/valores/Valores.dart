...
class Formatos {
  ...
  "VENTILATORIO: Apoyo ventilatorio ${Valores.dispositivoEmpleado}, mediante ${Valores.tuboEndotraqueal} ${Valores.haciaArcadaDentaria}, "
  ...
  "TAM ${Valores.presionArterialMedia} mmHg, ${Valores.apoyoAminergico}. "
  ...
  "Peso corporal total: ${Valores.pesoCorporalTotal} Kg, "
  "estatura: ${Valores.alturaPaciente} mts, "
  "I.M.C ${Valores.imc} Kg/m2, "
  "Peso predicho ${Valores.pesoCorporalPredicho} Kg. \n"
  ...
  "tasa de filtrado glomerular ${Valores.tasaRenalCrockoft_Gault} mL/min/1.73 m2 (Cockcroft - Gault). \n"
