...
class Cardiometrias {
  ...
  static String get transporteOxigeno => "Parámetros Hemodinamicos - "
      ...
      "\n"
      //
      "VO2  ${Gasometricos.CO.toStringAsFixed(2)}  mL O2/g Hb, "
      "IEO2(%) ${Gasometricos.IEO.toStringAsFixed(2)} %, "
      "DO2 ${Gasometricos.DO.toStringAsFixed(2)} mL/min,  "
      // "Consumo de Oxígeno (cO2): ${Valores.CAO.toStringAsFixed(2)} mL/min/m2, "
      "RVS ${Valores.RVS.toStringAsFixed(2)} Dinas/seg/cm2. "
      "TO2 ${Gasometricos.TO.toStringAsFixed(2)} mL/O2/m2. "
      "QS/QT ${Gasometricos.SF.toStringAsFixed(2)} %. "
      "\n"
  ...
  static String get cardiometrias =>
      ...
      "Capacidad de Oxígeno (CapO2): ${Gasometricos.CO.toStringAsFixed(2)}  mL O2/g Hb. "
      ...
      "Indice de Extracción de Oxígeno (I.E.O.): ${Gasometricos.IEO.toStringAsFixed(2)} %, "
      "Disponibilidad de Oxígeno (dO2): ${Gasometricos.iDO.toStringAsFixed(2)} mL/min,  "
      "Transporte de Oxígeno (TO2): ${Gasometricos.TO.toStringAsFixed(2)} mL/O2/m2. "
      "Shunt Fisiológico (QS/QT): ${Gasometricos.SF.toStringAsFixed(2)} %. "
