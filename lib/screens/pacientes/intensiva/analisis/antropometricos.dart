                    ...
                    child: Column(
                      children: [
                        ...
                        ValuePanel(
                          firstText: 'Edad',
                          secondText:
                              Valores.edad!.toDouble().toStringAsFixed(2),
                          thirdText: 'Años',
                        ),
                        ValuePanel(
                          firstText: 'PCT',
                        ...
                        ValuePanel(
                          ...
                          secondText:
                              Valores.circunferenciaCuello!.toStringAsFixed(2),
                          thirdText: 'mm',
                        ),
                        ValuePanel(
                          firstText: 'C. Cintura',
                          secondText:
                              Valores.circunferenciaCintura!.toStringAsFixed(2),
                          thirdText: 'mm',
                        ),
                        ValuePanel(
                          firstText: 'C. Cadera',
                          secondText:
                              Valores.circunferenciaCadera!.toStringAsFixed(2),
                          thirdText: 'mm',
                        ),
                        CrossLine(),
                        ValuePanel(
                          firstText: 'P. M. Mesobraquial',
                          secondText: Antropometrias.perimetroMesobraquial
                              .toStringAsFixed(1),
                          thirdText: 'cm',
                        ),
                        ValuePanel(
                          firstText: 'A. M.Mesobraquial',
                          secondText: Antropometrias.areaMesobraquial
                              .toStringAsFixed(1),
                          thirdText: 'cm2',
                        ),
                        ValuePanel(
                          firstText: 'A. Adip. Mesobraquial',
                          secondText: Antropometrias.areaAdiposaMesobraquial
                              .toStringAsFixed(1),
                          thirdText: 'cm2',
                        ),
                      ],
                                  ...
                                  SingleChildScrollView(
                                    ...
                                    child: Column(
                                      children: [
                                        ValuePanel(
                                          firstText: 'I.M.C.',
                                          secondText: Antropometrias.imc
                                              .toStringAsFixed(2),
                                          thirdText: 'Kg/m2',
                                        ),
                                        TittlePanel(
                                            textPanel:
                                                "Clase I.M.C. ${(Antropometrias.claseIMC)}"),
                                        CrossLine(),
                                        ValuePanel(
                                        ...
                                        ValuePanel(
                                          ...
                                          secondText: Antropometrias.PCIM
                                              .toStringAsFixed(2),
                                          thirdText: 'Kg',
                                        ),
                                        ValuePanel(
                                          firstText: 'P.C.I. (Broca)',
                                          secondText: Antropometrias.PCIB
                                              .toStringAsFixed(2),
                                          thirdText: 'Kg',
                                        ),
                                        ValuePanel(
                                          firstText: 'P.C.I. (Lorentz)',
                                          secondText: Antropometrias.PCIL
                                              .toStringAsFixed(2),
                                          thirdText: 'Kg',
                                        ),
                                        ValuePanel(
                                          firstText: 'P.C.I. (West)',
                                          secondText: Antropometrias.PCIW
                                              .toStringAsFixed(2),
                                          thirdText: 'Kg',
                                        ),
                                        CrossLine(),
                                  ...
                                  SingleChildScrollView(
                                    ...
                                    child: Column(children: [
                                      ValuePanel(
                                        ...
                                        secondText: Antropometrias.SC
                                            .toStringAsFixed(2),
                                        thirdText: 'm2',
                                      ),
                                      ValuePanel(
                                        firstText: 'Sup. Corporal Simp.',
                                        secondText: Antropometrias.SCS
                                            .toStringAsFixed(2),
                                        thirdText: 'm2',
                                      ),
                                      ValuePanel(
                                        firstText: 'SCT / Edad',
                                        secondText: Antropometrias.SCE
                                            .toStringAsFixed(2),
                                        thirdText: 'm2',
                                      ),
                                      ValuePanel(
                                        firstText: 'SCT (Haycock)',
                                        secondText: Antropometrias.SCH
                                            .toStringAsFixed(2),
                                        thirdText: 'm2',
                                      ),
                                    ]),
                                  ...
                                  SingleChildScrollView(
                                    ...
                                    child: Column(children: [
                                      ...
                                      ValuePanel(
                                        ...
                                        secondText: Antropometrias
                                            .pesoCorporalAjustado
                                            .toStringAsFixed(2),
                                        thirdText: 'Kg',
                                      ),
                                      ValuePanel(
                                        firstText: 'P.C.A. (IMC 25)',
                                        secondText: Antropometrias.PCB_25
                                            .toStringAsFixed(2),
                                        thirdText: 'Kg',
                                      ),
                                      ValuePanel(
                                        firstText: 'P.C.A. (IMC 30)',
                                        secondText: Antropometrias.PCB_30
                                            .toStringAsFixed(2),
                                        thirdText: 'Kg',
                                      ),
                                    ]),
                      ...
                      Expanded(
                        child: GrandButton(
                          ...
                          onPress: () {
                            Datos.portapapeles(
                                context: context,
                                text: Antropometrias.antropometricos(
                                    isAbreviado: false));
                          },
                        ),
                      ),
