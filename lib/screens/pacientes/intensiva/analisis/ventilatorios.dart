                      ...
                      child: Column(
                        children: [
                          ...
                          ValuePanel(
                            firstText: 'Vt (6)',
                            secondText:
                                Ventometrias.volumentTidal6.toStringAsFixed(0),
                            thirdText: 'mL',
                          ),
                          ValuePanel(
                            firstText: 'Vt (7)',
                            secondText:
                                Ventometrias.volumentTidal7.toStringAsFixed(0),
                            thirdText: 'mL',
                          ),
                          ValuePanel(
                            firstText: 'Vt (8)',
                            secondText:
                                Ventometrias.volumentTidal8.toStringAsFixed(0),
                            thirdText: 'mL',
                          ),
                          ValuePanel(
                            firstText: 'F. Vent',
                            ...
                            children: [
                              Expanded(
                                child: Wrap(children: [
                                  ValuePanel(
                                    firstText: "VM",
                                    secondText: Ventometrias.volumenMinuto
                                        .toStringAsFixed(1),
                                    thirdText: "L/min",
                                  ),
                                  ValuePanel(
                                  ...
                                  ValuePanel(
                                    ...
                                    secondText:
                                        (Ventometrias.drivingPressure * -1.0)
                                            .toStringAsFixed(2),
                                    thirdText: "L/cmH2O",
                                  ),
                                ]),
                              ...
                              Expanded(
                                child: SingleChildScrollView(
                                  ...
                                  child: Column(children: [
                                    ...
                                    ValuePanel(
                                      firstText: "iO2",
                                      secondText: Valores.indiceOxigenacion
                                          .toStringAsFixed(2),
                                      thirdText: "",
                                    ),
                                    ValuePanel(
                                    ...
                                    ValuePanel(
                                      firstText: "FiO2 Vent",
                                      secondText:
                                          Valores.VENT.toStringAsFixed(0),
                                      thirdText: "%",
                                    ),
                                    ValuePanel(
                                      firstText: "FiO2 Ideal",
                                      secondText:
                                          Valores.FIOI.toStringAsFixed(0),
                                      thirdText: "%",
                                    ),
                                    ValuePanel(
                                      firstText: "Vent. Ideal",
                                      secondText:
                                          Valores.FIOV.toStringAsFixed(0),
                                      thirdText: "Vent/min",
                                    ),
                                  ]),
                                ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: ValuePanel(
                                firstText: "W.O.B.",
                                secondText: Ventometrias.poderMecanico
                                    .toStringAsFixed(1),
                                thirdText: "cmH2O",
                              ),
                            ),
                            Expanded(
                              child: ValuePanel(
                                firstText: "Dyst",
                                secondText: Ventometrias.distensibilidadPulmonar
                                    .toStringAsFixed(2),
                                thirdText: 'mL/cmH2O',
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: ValuePanel(
                                firstText: "Ryst P.",
                                secondText: Ventometrias.resistenciaPulmonar
                                    .toStringAsFixed(2),
                                thirdText: 'mL/cmH2O',
                              ),
                            ),
