...
class Venosos extends StatefulWidget {
  const Venosos({Key? key}) : super(key: key);

  @override
  State<Venosos> createState() => _VenososState();
}

class _VenososState extends State<Venosos> {
  static var index = 10; // Venosos
