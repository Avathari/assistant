...
class Pancreaticos extends StatefulWidget {
  const Pancreaticos({Key? key}) : super(key: key);

  @override
  State<Pancreaticos> createState() => _PancreaticosState();
}

class _PancreaticosState extends State<Pancreaticos> {
  static var index = 5; // Pancreaticos
