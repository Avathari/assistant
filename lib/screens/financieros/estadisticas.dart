  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: isMobile(context) ? AppBar(
        backgroundColor: Colors.black,
        title: const Text('Estadísticas de los Activos del Usuario', style: Styles.textSyle,),
      ): null,
      body: isMobile(context) ? viewMobile():
        viewTablet()
    );
  }
  //
                        ...
                        Expanded(
                          ...
                          child: GridView(
                            gridDelegate: GridViewTools.gridDelegate(
                                crossAxisCount: isTablet(context) || isMobile(context)? 2 : 3,
